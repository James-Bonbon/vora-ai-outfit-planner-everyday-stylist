...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = "You are a wardrobe layout mapper. Output ONLY raw SVG code. ViewBox MUST be '0 0 1000 1000'. Map the boundaries using strictly <rect> elements. DO NOT output <text>, <path>, or <circle> elements. The only elements should be rectangles with these exact IDs: 'left_shelves', 'center_hanging_shirts', 'center_drawers', 'right_hanging_dresses', 'floor_storage'.";
