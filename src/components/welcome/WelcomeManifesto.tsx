...
const WelcomeManifesto = () => (
  <section className="max-w-3xl mx-auto py-24 md:py-32 px-6 text-center">
    <motion.p
      {...fadeUp(0)}
      className="text-[10px] uppercase tracking-[0.35em] text-[#e8e6e1]/30 font-outfit mb-10"
    >
      The Manifesto
    </motion.p>
    <motion.blockquote
      {...fadeUp(0.15)}
      className="font-serif-display text-2xl md:text-3xl lg:text-4xl font-light leading-[1.4] text-[#e8e6e1]/80 italic"
    >
