      ...
      return (
        ...
        >
          <div className="w-full md:w-1/2 text-left">
            <motion.p
              {...fadeUp(0)}
              className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-outfit mb-4"
            >
              {feat.label}
            </motion.p>
            <motion.h2
              {...fadeUp(0.1)}
              className="font-serif-display font-light text-3xl md:text-5xl tracking-tight mb-6 leading-[1.1] text-foreground"
            >
              {feat.title[0]}
              <br />
            ...
            <motion.p
              {...fadeUp(0.2)}
              className="font-outfit text-foreground/50 text-base md:text-lg leading-relaxed max-w-lg"
            >
              {feat.body}
            </motion.p>
          </div>
          ...
          <motion.div {...fadeUp(0.25)} className="w-full md:w-1/2">
            <div className="aspect-square rounded-2xl bg-foreground/[0.03] border border-muted-foreground/40 flex items-center justify-center backdrop-blur-sm">
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-foreground/[0.05] flex items-center justify-center">
                  <Icon className="w-5 h-5 text-muted-foreground" />
                </div>
                <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground font-outfit">
                  {feat.placeholder}
                </p>
              </div>
            </div>
